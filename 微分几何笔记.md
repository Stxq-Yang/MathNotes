...
然后我们就要证明它也是个流形，这个很简单，我们不难发现其实做了个对偶和$TM$是同胚的。因为这个映射$v\mapsto \alpha$可以拆成$\frac{\partial}{\partial x^i}\big |_p\mapsto dx^i$是显然同构的，合起来还是，所以很有趣，它依旧是$2 \operatorname{dim} M$维的光滑流形。
